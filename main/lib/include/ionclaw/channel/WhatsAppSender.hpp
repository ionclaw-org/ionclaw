...
public:
    ...
    // z-api media fields accept a base64 data url or a public url with kind image, audio, video, or document
    ...
    // meta sends media by a public link where the caption applies to everything except audio

...
class OpenAIStyleImageGenerator : public ImageGenerator
{
public:
    explicit OpenAIStyleImageGenerator(std::string providerName);
...
private:
    // image generation (no reference images)
    ...
    // image editing with reference images (multipart form data)
